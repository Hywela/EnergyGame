...
void Window::mainLoop() {	
	...
	std::string s = std::to_string(timer - SDL_GetTicks() / 1000);
		ren->mainLoop(s);
...
void Window::setupWorld() {
	...
	worldSimulation = new thread(&World::checkForInput, new World(screenwidth, screenheight, inQueue, renderQueue));
